...
### Added
- **Clip trimming in the player**: a scissors button opens trim mode —
  drag the range handles (the player seeks live to whichever edge you
  drag, so you see the exact cut frame), then "Save trimmed clip" exports
